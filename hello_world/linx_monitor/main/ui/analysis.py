...
class Ui_nmonAnalysis_Form(object):
    def setupUi(self, nmonAnalysis_Form):
        ...
        self.cpu_widget.setLimits(xMin=-1, yMin=-2, xMax=6000, yMax=150, minXRange=25, minYRange=20, maxXRange=1000)
        ...
        self.mem_widget.setLimits(xMin=-1, yMin=-2, xMax=6000, yMax=150, minXRange=25, minYRange=20, maxXRange=1000)
        ...
        self.disk_widget.setLimits(xMin=-5, yMin=-2, xMax=6000, yMax=200, minXRange=25, minYRange=30, maxXRange=1000)
        ...
        self.iops_widget.setLimits(xMin=-5, yMin=-2, xMax=6000, yMax=600, minXRange=25, minYRange=20, maxXRange=1000)
        ...
        self.net_widget.setLimits(xMin=-5, yMin=-2, xMax=6000, yMax=150, minXRange=25, minYRange=20, maxXRange=1000)
    ...
    def retranslateUi(self, nmonAnalysis_Form):
        ...
        self.moveStart_pushButton.setText(_translate("nmonAnalysis_Form", "移至开始点"))
        self.moveEnd_pushButton.setText(_translate("nmonAnalysis_Form", "移至结束点"))
        self.reset_pushButton.setText(_translate("nmonAnalysis_Form", "图像重置"))
        self.pushButton_2.setText(_translate("nmonAnalysis_Form", "重新计算"))
        self.pushButton_4.setText(_translate("nmonAnalysis_Form", "导出"))
        self.label_4.setText(_translate("nmonAnalysis_Form", "区间内统计数据"))
