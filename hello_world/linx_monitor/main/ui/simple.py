...
class Ui_simple_Form(object):
    def setupUi(self, simple_Form):
        ...
        self.analysis_record = QtWidgets.QPushButton(simple_Form)
        self.analysis_record.setMaximumSize(QtCore.QSize(60, 20))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/clear.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.analysis_record.setIcon(icon)
        self.analysis_record.setObjectName("analysis_record")
        self.gridLayout.addWidget(self.analysis_record, 2, 1, 1, 1)
    ...
    def retranslateUi(self, simple_Form):
        ...
        self.analysis_record.setText(_translate("simple_Form", "分析"))
